...
contract ShonaProxyBaseScript is Script {
    function run() public {
        ...
        // For Base network deployment with ATL token
        IERC20 atlToken = IERC20(0x0b9F23645C9053BecD257f2De5FD961091112fb1); // ATL token address
        
        console.log("Deploying ShonaProxy on Base network...");
        console.log("ATL token:", address(atlToken));
        console.log("USDC stable token:", 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913);
        console.log("IDRX stable token:", 0x18Bc5bcC660cf2B9cE3cd51a404aFe1a0cBD3C22);
        
        ShonaProxy proxy = new ShonaProxy(atlToken);
